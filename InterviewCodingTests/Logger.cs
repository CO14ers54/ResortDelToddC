...
namespace InterviewCodingTests
{
   class Logger
   {
      ...
      public void WriteEntry(ToddApplications.Application application, string message, MessageType messageType)
      {
         try
         {
      ...
      /// <param name="message">The text of the message itself</param>
      /// <param name="messageType">The message type from the Message Type enumeration</param>
      private void WriteEventLogEntry(ToddApplications.Application application, string message, MessageType messageType)
      {
      ...
      /// <param name="message">The text of the message itself</param>
      /// <param name="messageType">The message type from the Message Type enumeration</param>
      private void WriteDatabaseLogEntry(ToddApplications.Application application, string message, MessageType messageType)
      {
         /*
